...
pipe = Pipeline([("preprocess", pre_tree), ("clf", RandomForestClassifier(random_state=42, n_estimators=150))])
from sklearn.model_selection import GridSearchCV
param_grid = {"clf__max_depth":[None,8], "clf__min_samples_leaf":[1,3], "clf__max_features":["sqrt", None]}
