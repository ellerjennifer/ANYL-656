...
# GridSearch template (adjust if desired)
pipe = Pipeline([("preprocess", pre_linear), ("clf", LogisticRegression(max_iter=1500, solver="liblinear"))])
from sklearn.model_selection import GridSearchCV
param_grid = {"clf__C":[0.5, 1.0], "clf__penalty":["l1","l2"]}
